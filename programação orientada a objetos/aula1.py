# Exercício: Introdução à programação
# Objetivo: Praticar conceitos iniciais como entrada, saída e variáveis.
...
#x, y, z = minha_quarta_funcao("rodrigo massimino")
#print(minha_quarta_funcao("rodrigo massimino"))
